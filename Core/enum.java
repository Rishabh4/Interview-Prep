...
L2-00:00 Can we create 'enum' object explicitly?
    ...
    Because if we want to create any new object w of type Week enum, then we can declare w as enum constant!
    So there is no need of creating enum object explicitly ..
    -> Week w:
                enum Week{
...
L2-07:09 Can we use Enum with TreeSet or TreeMap in Java?
    ...
    👉🏻 Since Enum by default implements Comparable interface, they can be used inside TreeSet or TreeMap.
