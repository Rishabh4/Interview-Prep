...
L2-00:29 What are the Access modifiers in java?
	Access Modifiers are the keywords in object oriented language, which set the accessibility of classes or methods or any members.
...
L3-00:02 What is a Package?
	...
	Packages provides a folder structure to organize our classes-interfaces, so that one can easily search and use them.
...
L3-03:10 Which access modifier is the least restrictive and which is the most restrictive?
	Least Restrictive Modifier: Public access modifier. It is also known as Universal Access Modifier.
...
L4-00:04 What are non-access modifiers in java?
	...
	2. Final :
			final specifier is used to restrict further modifications on any class, any method or any variable.
			-> if any primitive variable is final, we cannot change its value in whole program.

	3. Abstract :
			abstract specifier is used to mark the method or Class to be incomplete and it must be
...
L4-10:48 Can we instantiate abstract classes?
	Answer is No, since abstract classes are not fully implemented that is why we cannot create objects of them.

L4-11:29 Can we define top level Class as static?
	Answer is No. static keyword is applicable only for Class members or nested cleasses.
...
L4-12:09 Why do we define members as static?
	...
	We can call static members without creating objects, by just invoking them with the classname.
		...
		Now we can simply call "Demo.display();"
...
L6-04:53 Are there any global variables in java?
	Global variables are generally those variable which can be accessed by other part of program or outside the class.
...
L6-17:06 What is the use of private constructor in Java?
	...
	constructors private, then we can create objects of the Class only inside that Class internally.
...
L6-22:02 What are Static methods?
	...
	-> To call static method: Addition.get();
...
L6-23:24 What are method declarations?
	When we do not define the body of method, and end it with a semi-colon then that is called method declaration.
...
L6-24:15 What are interfaces?
	...
	i.e, Interfaces only have default and static methods that can have implementations,
	There are only method declarations and all the methods are abstract and public by default.
...
L6-25:57 What is a native method?
	A native method is a method which is implemented in a non-java language, and is targeted for a single machine type.
...
L6-26:53 Can we create object for final class?
	Yes, we can definitely create an object for final class. Example is class: String. It is a final class.

//OOPS

L7-00:13 What is OOPS?
    OOPS stands for Object Orieted programming System.
    Object oriented programming is a Programming paradigm to write programs based on real world objects,
	in that world, the states and behaviour of an object are the variable and methods.

L7-01:15 What are the advantages of OOPS?
    These are the major advantages of OOPS:
    1. Simplicity: Since OOPS consists real world objects, so the program structure remains clear to everyone without
         any complexity.
    2. Modularity: In object oriented paradigm, each object forms a separate entity. For each object, their state,
         behaviour and other internal workings are decoupled from other parts of system.
    3. Modifiability: With OOPs, it is easy to change the data representation and methods. Changes inside
         any particular Class do not affect any other part of the program.
    4. Extensibility: This is about adding New features by modifying some existing modules. OOPs allows to do that.
    5. Maintainability: The objects can be maintained by fixing problems easier.
...
L8-01:04 What is difference between Abstract Class and Interface?
    ...
    1. In abstract class, we can have both abstract and concrete methods where as in Interface,
       we can have abstract methods, they cannot have concrete methods.
...
L9-00:58 What are the various types of inheritance?
    These are 6 types of inheritance:
...
L9-07:21 What is the difference between Late Binding and Early Binding?
    ...
    i.e, when a method is called in java, the program control binds to the memory address where that method is defined.
...
L11-01:36 What is IS-A and HAS-A relationship?
    ...
    -> There is a 'Teacher' Class which extends a 'Person'. So here a teacher is a person. and it is
