...
What is Inner class?
    Any Class which is not a top level Class or any Class which is declared inside another Class is Inner class.
...
What is the difference between Static nested Class and Member Inner class?⭐️
    ...
    👉🏻 We can not declare static methods inside Regular inner classes whereas in static nested classes, we can do so.
       So we can declare main method in static nested class, whereas in regular inner classes we cannot.

    👉🏻 We can Import Nested Static Class with static import, whereas we normally Import the non static nested classes.
...
What is Anonymous Inner class?⭐️⭐️
    Anonymous Inner Class is a Class which does not have name to reference and initialised at the same place where it gets created.
...
When should we use Anonymous inner classes?
    ...
    functionalities such as overloading methods of a class, or interface, without having actually any subclass.
