...
//        copyBinaryFile(false); 
    ...
    public static void copyTextFile(boolean buffering){
        File src = new File ("C:\\Users\\skennedy\\Documents\\NetbeansProjects\\Udemy\\src\\main\\java\\lets_get_certified\\io\\ReadingWritingExamples.java");
        File dest = new File ("C:\\Users\\skennedy\\Documents\\NetbeansProjects\\Udemy\\src\\main\\java\\lets_get_certified\\io\\ReadingWritingExamples2.java");
    ...
    public static void copyBinaryFile(boolean buffering){
        ...
        File src = new File ("./target/classes/lets_get_certified/io/ReadingWritingExamples.class");
        File dest = new File ("./target/classes/lets_get_certified/io/ReadingWritingExamples2.class");
