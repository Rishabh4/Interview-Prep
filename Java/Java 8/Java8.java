...
2. So, What is Lambda Expression ?
	...
	In Java Lambda Expressions is the anonymous functions that can be Passed into another method as argument.
	A function that can be created without belonging to any class. Lambda Expression facilitate passing Behavior or Functions
	as parameter to another Functions. This also enables the programming language to be as functional programming language.
		...
		//We can use the below expression to pass the implementation of the disp() of Display interface
		Display dis = () -> System.out.println("Rishabh");

		//To call the method execute below expression
		dis.disp();
...
7. Can you Name a few Functional Interfaces that are already there in Java 8 to use.
	The answer of this question is there are 40+ predefined functional interfaces in Java, Some of the very important functional interfaces to remember are
   ...
   import java.util.function.Function;
	...
	public class Parctice01 {
		...
		public static void main(String[] args) {
			...
			// There is a method in String toUpperCase and we can refer this using Functional Interface
...
9. Another most important Question the interview may ask is, What is Functional Programming.
	...
	In Functional programming Functions are the first class Citizens, can be passed to another functions and can be returned from another functions.
...
10. What is pure Function?
	...
	The return value of the pure functions solely depends on its arguments. Hence, if you call the pure functions with the
	same set of arguments, you will always get the same return values.
...
11. What are Higher Order Functions? or Functional Composition?
	...
	The Functions that return another Function is called Higher Order Functions, and applying these functions one by one
	like Fluid Operations are called Functional Composition. Lets understand this with an Example -
...
13. What do you mean by Pipeline of Operations?
	...
	Intermediate operations are lazy and will not be called until the Terminal operation is called. To identify if the
		operation is Intermediate or not we can check if the operation is returning another stream it is called intermediate operation.
...
14. What do you mean by Lazy evaluation?
	...
	public class Parctice02 {
		...
		public static void main(String[] args) {
			...
			// This is just a Intermediate Operation Let see if the get Method gets executed by Putting a Debug code there
