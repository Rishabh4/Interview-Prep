...
public class FI_from_API {
    ...
    public void supplier() {
        ...
        //      T get()
        // Best used for deffered execution & unit test case failure
    ...
    public void function() {
        ...
        BiFunction<String, String, String> biFn2   = (s1, s2) -> s1.concat(" ").concat(s2);
    ...
    public void unaryBinaryOperator() {
        ...
        //      T apply(T t)
        // Special type of Function where type of input and output has to be same
        ...
        //      T apply(T t1, T t2)
        // Special type of Function where type of both the inputs and the output has to be same
        BinaryOperator<String> binaryOp   = (s1, s2) -> s1.concat(" ").concat(s2);
