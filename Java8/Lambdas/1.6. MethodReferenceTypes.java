...
public class MethodReferenceTypes {
    ...
    public static void unboundMethodReferences(){
        ...
        BiFunction<String, String, String> concatL   = (s1, s2) -> s1.concat(" ").concat(s2);
        ...
        // "Sean ".concat("Kennedy")
        System.out.println(addSpace("Sean", "Kennedy", concatMR));// Sean Kennedy
    }

    public static String addSpace(String str, String str2, BiFunction<String, String, String> func) {
        String str3 = func.apply(str, " ");
        return func.apply(str3, str2);
    }
